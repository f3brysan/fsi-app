                            ...
                            <form action="{{ route('biodata.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nickname') is-invalid @enderror"
                                        name="nickname" id="nickname" value="{{ old('nickname') }}" required
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        name="birth_place" id="birth_place" value="{{ old('birth_place') }}" required
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="col-sm-3">
                                        <input class="form-control @error('birth_day') is-invalid @enderror"
                                            type="date" id="example-date-input" name="birth_day">
                                        @error('birth_day')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('domisili') is-invalid @enderror"
                                        name="domisili" id="domisili" value="{{ old('domisili') }}" required
                                        placeholder="Contoh : Jl. Raya Kalimantan Blok AA. Kawasan Industri MM2100" />
                                    @error('domisili')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        class="form-control @error('no_rangka') is-invalid @enderror" name="no_rangka"
                                        id="no_rangka" value="{{ old('no_rangka') }}" required
                                        placeholder="Contih : MHB1231AWERGxxxxx" />
                                    @error('no_rangka')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('no_mesin') is-invalid @enderror"
                                        name="no_mesin" id="no_mesin" value="{{ old('no_mesin') }}" required
                                        placeholder="Contoh : J1A2321xxxx" />
                                    @error('no_mesin')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('no_sim') is-invalid @enderror"
                                        name="no_sim" id="no_sim" value="{{ old('no_sim') }}" required
                                        placeholder="Contoh : 9912312XXX" />
                                    @error('no_sim')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div>
                                    <button type="submit"
                                        class="btn btn-md btn-primary waves-effect waves-light me-1">
                                        Submit
                                    </button>
