                                            ...
                                            <div class="col-md-3">
                                                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                                    ...
                                                    <a class="nav-link mb-2 active" id="v-pills-home-tab"
                                                        data-bs-toggle="pill" href="#v-pills-biodata" role="tab"
                                                        aria-controls="v-pills-home" aria-selected="true">Profil Diri</a>
                                                    <a class="nav-link mb-2" id="v-pills-profile-tab" data-bs-toggle="pill"
                                                        href="#v-pills-komunitas" role="tab"
                                                        aria-controls="v-pills-profile" aria-selected="false">Asal
                                                        Komunitas</a>
                                                </div>
                                            </div>
                                            <div class="col-md-9">
                                                <div class="tab-content text-muted mt-4 mt-md-0" id="v-pills-tabContent">
                                                    <div class="tab-pane fade show active" id="v-pills-biodata"
                                                        ...
                                                        <div class="px-2">
                                                            ...
                                                            @else
                                                                <img class="card-img avatar-lg"
                                                                    src="assets/images/users/avatar-1.jpg" alt="Card image">
                                                            @endif
                                                        </div>
                                                        <table class="table">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>{{ $biodata->birth_place }},
                                                                        {{ $biodata->birth_day }}</td>
                                                                </tr>
                                                                <tr>
                                                                <tr>
                                                                    <td>Jenis Kelamin dan Golongan Darah</td>
                                                                    <td>{{ $biodata->gender }} | Gol Darah
                                                                        {{ $biodata->blood }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Domisili </td>
                                                                    <td>{{ $biodata->domisili }}, {{ $biodata->kota }},
                                                                        {{ $biodata->provinsi }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Email</td>
                                                        ...
                                                        <div class="card-body">
                                                            <a href="{{ route('biodata.edit', $parr) }}"
                                                                class="card-link">Edit</a>
                                                        </div>
                                                    </div>
                                                    <div class="tab-pane fade" id="v-pills-komunitas" role="tabpanel"
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            @else
                                                                                <span
                                                                                    class="badge badge-soft-info">Member</span>
                                                                            @endif
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                        ...
                                                        @else
                                                            ...
                                                            <br><br>
                                                            <div class="d-grid"><a
                                                                    href="{{ route('anggotakomunitas.create') }}"
                                                                    class="btn btn-default">Gabung Komunitas</a></div>
                                                        @endif
                                                    </div>
