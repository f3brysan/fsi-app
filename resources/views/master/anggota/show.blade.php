                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('PPkomunitas.index') }}">Data Komunitas</a>
                                </li>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="post-thumb thumb">
                            <img class="img-fluid img-center" src="{{ asset('storage/' . $komunitas->picture) }}"
                                alt="{{ $komunitas->slug }}">
                        </div>
                        <div class="card-body">
                            <p class="card-text">Berdiri pada :
                                {{ date('d F Y', strtotime($komunitas->tgl_berdiri)) }}<br>
                                ...
                                <tbody>
                                    @foreach ($anggota as $get)
                                        <tr>
                                            ...
                                            <td><a class="btn btn-sm btn-primary" id="#myModal" data-bs-toggle="modal"
                                                    data-bs-target="#myModal{{ $get->biodata->uuid }}"><i
                                                        class="ri-eye-fill"></i> Lihat</a>
                                                <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                                    action="{{ route('PPkomunitas.destroy', $get->uuid) }}"
                                                    method="POST" class="d-inline">
                                                    @method('DELETE')
                                                    @csrf
                                                    <button type="submit" class="btn btn-sm btn-danger"><i
                                                            class="ri-delete-bin-2-line"></i> Hapus</button>
                                                </form>
                                            </td>
                                        </tr>
                                    @endforeach
...
<div id="myModal{{ $anggota->biodata->uuid }}" class="modal fade" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card">
                    <img class="card-img-top img-thumbnail" src="{{ asset('storage/' . $anggota->biodata->picture) }}"
                        alt="Card image cap">
                    <div class="card-body">
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $anggota->biodata->gender }} | Gol Darah {{ $anggota->biodata->blood }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>Domisili </td>
